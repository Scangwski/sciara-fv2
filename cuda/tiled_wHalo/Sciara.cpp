...
// =============================================================
//  ALLOCATE SUBSTATES (Unified Memory for CUDA)
// =============================================================
...
// =============================================================
//  DEALLOCATE SUBSTATES (Unified Memory)
// =============================================================
...
// =============================================================
//  POWER-LAW PARAMETER COMPUTATION
// =============================================================
...
// =============================================================
//  NEIGHBORHOOD OFFSETS (Unified Memory)
// =============================================================
...
void init(Sciara*& sciara)
{
    ...
    // Allocate Xi/Xj in Unified Memory
    ...
    sciara->substates = new Substates; // actual data allocated after loading
